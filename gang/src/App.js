...
const NFT = () => {
  ...
  const addNums = useCallback(() => {
    setNumsToMint((num) => Math.min(collectionInfo.MAX_MINT_PER_TX, num + 1)); // @Todo: there's a issue here, maybe total
  }, [collectionInfo.MAX_MINT_PER_TX]);
